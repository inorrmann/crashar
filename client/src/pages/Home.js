        ...
        <div className="home overflow-auto">
            ...
            <div style={{ fontFamily: "Barlow" }}>
                ...
                <div className="py-2 mx-3 shadow" style={{ backgroundColor: "rgba(15, 14, 12, .3)" }}>
                    ...
                    <h5 className="text-center text-white px-5 homeText mt-4" style={textShadow}>Find like-minded people to share a campsite with. <br/>
                    <Link style={{color: "#EBC023"}} to="/signup" >Sign Up Now!</Link></h5>
                </div>
            </div>
        </div>
    );
